        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <div className="rounded-xl border border-neutral-200 bg-white aspect-square shadow-sm overflow-hidden">
              <Image
                src="https://images.unsplash.com/photo-1689857538296-b6e1a392a91d?q=80&w=806&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                width={500}
                height={500}
